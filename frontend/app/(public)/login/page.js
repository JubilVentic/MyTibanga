...
export default function LoginPage() {
    ...
    // "choose" = role selection screen, "admin-face" = face scan, "password" = username/password form
    ...
    const handleFaceCapture = async (image) => {
        ...
        try {
            ...
            // If there are no enrolled admin faces yet, move user directly to password login.
    ...
    return (
        <>
                            ...
                            <>
                                ...
                                <div className={styles.roleSelection}>
                                    ...
                                    >
                                        ...
                                        <span className={styles.roleName}>Admin Login</span>
                                        <span className={styles.roleDesc}>
                                            {cameraLoginEnabled ? 'Face Recognition' : 'Face login disabled'}
                                        </span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className={styles.roleName}>Resident Login</span>
            ...
            {/* Loading Overlay (face verification uses faceSubmitting so FaceScanner stays mounted) */}
